...
const CancellationRequests = ({ userEmail1, bookingId, ticketId }) => {
  ...
  useEffect(() => {
    ...
    const fetchRequests = async () => {
      try {
        ...
        const cancellationsRef = collection(db, `users/${userEmail1}/bookings/${bookingId}/tickets/${ticketId}/cancellations`);
  ...
  useEffect(() => {
    ...
    const fetchApprovedRequests = async () => {
      try {
        const approvedRef = collection(db, `users/${userEmail1}/bookings/${bookingId}/tickets/${ticketId}/approvedRequests`);
  ...
  useEffect(() => {
    ...
    const fetchRejectedRequests = async () => {
      try {
        const rejectedRef = collection(db, `users/${userEmail1}/bookings/${bookingId}/tickets/${ticketId}/rejectedRequests`);
  ...
  const handleApprove = async (id) => {
    try {
      const requestRef = doc(db, `users/${userEmail1}/bookings/${bookingId}/tickets/${ticketId}/cancellations`, id);
      ...
      if (requestSnap.exists()) {
        ...
        const approvedRef = doc(db, `users/${userEmail1}/bookings/${bookingId}/tickets/${ticketId}/approvedRequests`, id);
  ...
  const handleReject = async (id) => {
    try {
      ...
      if (requestSnap.exists()) {
        ...
        const rejectedRef = doc(db, `users/${userEmail1}/bookings/${bookingId}/tickets/${ticketId}/rejectedRequests`, id);
