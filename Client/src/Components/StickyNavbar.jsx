...
export function StickyNavbar() {  
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 animate__animated animate__fadeInDown">
      ...
      <NavLink to="/qr" className={({ isActive }) => (isActive ? 'p-1 font-bold  text-blue-900 dark:text-gray-300 text-[15px] hover:text-blue-600 dark:hover:text-blue-400 nav-item' : 'p-1 font-normal dark:text-gray-300 text-[15px] hover:text-blue-600 dark:hover:text-blue-400 nav-item')}>
